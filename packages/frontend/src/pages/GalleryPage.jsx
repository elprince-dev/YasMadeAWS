      ...
      <div className="container-custom">
        ...
        <motion.div variants={itemVariants} className="text-center mb-16">
          <h1 className="text-5xl md:text-6xl font-bold text-gray-900 dark:text-white mb-6">
            Our{' '}
            <span className="gradient-text bg-clip-text text-transparent bg-gradient-to-r from-violet-600 to-fuchsia-600">
              Gallery
            </span>
          </h1>
          <p className="text-xl text-gray-600 dark:text-gray-400 max-w-3xl mx-auto leading-relaxed">
            Discover the beauty of handcrafted embroidery through our collection
            of workshops, finished pieces, and creative moments that capture the
            essence of YasMade.
          </p>
        </motion.div>
        ...
        >
          ...
          <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
            Be part of these beautiful moments. Join our workshops and create
