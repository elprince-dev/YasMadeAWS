      ...
      <div className="relative h-screen flex items-center justify-center overflow-hidden">
        ...
        >
          <h1 className="text-6xl md:text-7xl font-bold text-white mb-6 tracking-tight">
            About{' '}
            <span className="gradient-text bg-clip-text text-transparent bg-gradient-to-r from-yellow-200 to-pink-200">
              YasMade
            </span>
          </h1>
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div>
                ...
                <p className="text-lg text-gray-600 dark:text-gray-300 leading-relaxed mb-6">
                  Yasmade is a handmade embroidery brand that celebrates
                  creativity, mindfulness, and the beauty of slow art. Founded
                  by Yasmeen, Yasmade creates elegant embroidery hoops and
                  stitched designs for home décor and gifts. Alongside her art,
                  Yasmeen offers engaging embroidery workshops for kids, teens,
                  and adults , encouraging creativity, focus, and confidence
                  through the art of stitching. Whether you’re looking for a
                  handmade keepsake or a creative experience, Yasmade is where
                  inspiration is stitched into every detail.
                </p>
          ...
          >
            ...
            <div className="relative z-10">
              ...
              <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto leading-relaxed">
                Whether you are drawn to our handcrafted embroidery pieces,
                eager to learn the art of stitching, or simply inspired by our
                love for Islamic art, we would love to have you join our growing
                creative community.
              </p>
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                ...
                <a
                  href="/sessions"
                  className="inline-flex items-center px-8 py-4 bg-white/20 text-white rounded-full font-semibold hover:bg-white/30 transition-colors backdrop-blur-sm"
                >
                  Join a Workshop
                  <FiArrowRight className="ml-2 w-5 h-5" />
                </a>
